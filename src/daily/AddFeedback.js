...
export default function AddFeedback() {
  ...
  return (<>
    <Welcome></Welcome>
    <Form className="dailyFeedBackForm" method="put" >
      <p>
        <label className="mainLabel" htmlFor="socialtext"> How would you describe the social atmosphere today? </label>
        <input id="socialtext" className="textInput" type="text" name="socialtext" required />
      </p>
      <p>
      ...
      <p>
        ...
        <input className="textInput" id="generaltext" type="text" name="generaltext" required />
      </p>
      <p>
